...
$token = file_get_contents("6324369008:AAEfJEjHJW2_VozhQUdQLuixXJ-2X4ulzgs");
...
function ph($ph, $group) {
	...
	$settings['app_info']['api_id'] = 15145595;
	$settings['app_info']['api_hash'] = 'c3f60ecf742e136436acc9082ac8d9a4';
...
- 𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒅 𝒃𝒚 𝑨𝒃𝒐𝒐𝒅 𝒀𝒂𝒃𝒂 🇮🇶 @eeuwr .
",'parse_mode' => "MarkDown", 'disable_web_page_preview' => true,
'reply_markup' => json_encode(['inline_keyboard' => [
[['text' => "- 𝑨𝒃𝒐𝒐𝒅 𝒀𝒂𝒃𝒂'", 'url' => "https://t.me/eeuwr"]],
[['text' => "-𝒎𝒆 𝒄𝒉𝒂𝒏𝒏𝒆𝒍'", 'url' => "https://t.me/Xx3bD"]],
]]) 
]);
}
...
if ($text == "->") {
bot('sendMessage', ['chat_id' => $chat_id, 'text' => "𝒘𝒆𝒍𝒄𝒐𝒎𝒆 , \n𝒊𝒏 𝒕𝒉𝒆 𝒄𝒉𝒆𝒄𝒌𝒆𝒓 𝒖𝒔𝒆𝒓 𝒏𝒂𝒎𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 \n𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒅 𝒃𝒚 𝑨𝒃𝒐𝒐𝒅 𝒀𝒂𝒃𝒂 🇮🇶 @eeuwr . ", 'reply_markup' => json_encode(['resize_keyboard' => true, 'keyboard' => [
[["text" =>"𖠜 Numbers"],["text" =>"𖠜 Requests"]],
[["text" =>"𖠜 Run"],["text" =>"𖠜 Stop"]],
[["text" =>"𖠜 Add Users"],["text" =>"𖠜 Delet User"]],
[["text" =>"𖠜 To Bot ↺ Band"]],
...
'text' => "𝒘𝒆𝒍𝒄𝒐𝒎𝒆 , \n𝒊𝒏 𝒕𝒉𝒆 𝒄𝒉𝒆𝒄𝒌𝒆𝒓 𝒖𝒔𝒆𝒓 𝒏𝒂𝒎𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 \n𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒅 𝒃𝒚 𝑨𝒃𝒐𝒐𝒅 𝒀𝒂𝒃𝒂 🇮🇶 @eeuwr . ",
'reply_markup' => json_encode(['inline_keyboard' => [
[['text'=>"-𝑨𝒃𝒐𝒐𝒅 𝒀𝒂𝒃𝒂 🇮🇶'", 'url' => "https://t.me/l_lll"],['text'=>"-𝒎𝒆 𝒄𝒉𝒂𝒏𝒏𝒆𝒍'", 'url' => "https://t.me/iii8i"]],
]]) 
]);
unlink('mode');
}
...
'text'=>"⌁ Data Checker Band , king @eeuwr 🐊",
'reply_markup'=>json_encode(['inline_keyboard'=>[
...
bot('sendMessage',['chat_id'=>$chat_id2,'message_id'=>$message_id,
'text'=>"⌁ Data Checker bot , king @eeuwr 🐊",
'reply_markup'=>json_encode(['inline_keyboard'=>[
